...
public class Controller {
    ...
    public List<reserva> ListaFiltrosReserva(String pId,String pDataInicio,String pDataFim, String pStatus, String pResponsavel, String pDestinatario){
    	try {
    		return vDaoReserva.listarFiltro(pId, pDataInicio, pDataFim, pStatus, pResponsavel, pDestinatario);
		} catch (Exception e) {
