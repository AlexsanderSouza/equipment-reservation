...
public List<reserva> listarFiltro(String pId,String pDataInicio,String pDataFim, String pStatus, String pResponsavel, String pDestinatario) throws Exception{
    ...
    if ( pDataInicio.equals(vNull) || pDataInicio.equals(vVazia)  ) {
		
   } else {
	   vSQL_Aux = vSQL_Aux+" AND data_hora_reserva = "+"'"+pDataInicio+"'";
   }
    
    if ( pDataFim.equals(vNull) || pDataFim.equals(vVazia)  ) {
		
   } else {
	   vSQL_Aux = vSQL_Aux+" AND data_hora_final = "+"'"+pDataFim+"'";
   }
