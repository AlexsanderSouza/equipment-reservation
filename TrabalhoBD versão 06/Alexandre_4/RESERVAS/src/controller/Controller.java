...
public class Controller {
    ...
    public List<reserva> ListaFiltrosRecurso(String pId,String pDataInicio,String pDataFim, String pDataInicio2,String pDataFim2, String pStatus, String pResponsavel, String pDestinatario){
    	try {
    		return vDaoReserva.listarFiltro(pId, pDataInicio, pDataFim, pDataInicio2, pDataFim2, pStatus, pResponsavel, pDestinatario);
		} catch (Exception e) {
			// TODO: handle exception
