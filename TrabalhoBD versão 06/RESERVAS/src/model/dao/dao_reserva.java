...
alerta vAlerta = new alerta();
	...
	public List<reserva> listarFiltro(String pId,String pDataInicio,String pDataFim, String pDataInicio2, String pDataFim2, String pStatus, String pResponsavel, String pDestinatario) throws Exception{
	    String vSQL = "SELECT rs.*, us.nome destinatario, us2.nome responsavel, tp.nome nomeTipoRecurso "+
	                  "FROM reserva rs "+
	    		      "left join usuario us on us.id = rs.id_destinatario "+
	                  "left join usuario us2 on us2.id = rs.id_responsavel "+
	    ...
	    while(rs.next()){
	        ...
	        vReserva.setNomeResponsavel("responsavel");
	        vReserva.setNomeDestinatario("destinatario");
	        vReserva.setNomeTipoRecurso("nomeTipoRecurso");
