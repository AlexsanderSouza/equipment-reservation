...
public class controllerReserva implements Initializable{
	...
	@FXML
	private VBox vboxReserva,vboxPeriodoCadastro; //Para usar o botão dinamico de data e hora
	...
	DateTimePicker vDataTimeInicioReserva = new DateTimePicker();
	DateTimePicker vDataTimeFimReserva = new DateTimePicker();
	DateTimePicker dataTimeListagem = new DateTimePicker();
	DateTimePicker vDataTimePesqDataInicial = new DateTimePicker();
	DateTimePicker vDataTimePesqDataFinal = new DateTimePicker();
    ...
    public void Filtro(){
    	...
    	try {
    		vDataInicio = vDataTimePesqDataInicial.getTextField().getText();     				
        	vDataFim = vDataTimePesqDataFinal.getTextField().getText();
    ...
    public void dataTimePicker() {                                  //insere o botão dinamico de data e hora
    	...
    	vboxReserva.getChildren().add(vDataTimeInicioReserva);
    	vboxReserva.getChildren().add(vDataTimeFimReserva);
    	
    	vboxPeriodoCadastro.setSpacing(05);
    	vboxPeriodoCadastro.getChildren().add(vDataTimePesqDataInicial);
    	vboxPeriodoCadastro.getChildren().add(vDataTimePesqDataFinal);
    }
   ...
   // String primeiroNome = nome.substring(0, nome.indexOf(" "));
    ...
    public void inserirReserva(){
    	...
    	String vDataInicio = vDataTimeInicioReserva.getTextField().getText();
    	String vDataFinal = vDataTimeFimReserva.getTextField().getText();
    ...
    public void preencherRecurso(List<recurso> rec) throws Exception{
    	...
    	for (recurso vrec : rec){
    		vListaRecurso = Integer.toString(vrec.getId())+" - "+vrec.getNome();
