...
insert into unidade (nome, email, telefone, endereco) values('teste1','teste@teste.com','9999-9999','rua');

INSERT INTO tipo_recurso (nome) values ('cabo');
INSERT INTO tipo_recurso (nome) values ('teclado');
INSERT INTO tipo_recurso (nome) values ('mouse');

insert into recurso (nome, etiqueta, observacao, id_unidade, id_tipo_recurso)
...
select count(id_tipo_recurso) from recurso where id_tipo_recurso = 1
...
where rs.data_hora_reserva >= '2017-10-03 23:30:00' 
  and rs.data_hora_final <= '2017-10-03 23:50:00'
)) qtde_disponivel ,
...
where rs.status = 'ATIVO'
  and rs.id_recurso = 1
  and rs.data_hora_reserva >= '2017-10-03 23:30:00' 
  and rs.data_hora_final <= '2017-10-03 23:50:00'
