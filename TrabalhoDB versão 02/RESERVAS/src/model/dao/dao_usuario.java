...
public class dao_usuario {
    ...
    public List<usuario> listar(usuario pUser) throws Exception{
        ...
        while(rs.next()){
            ...
            vUser.setAtivo(rs.getString("ativo"));
    ...
    public void inserir(usuario pUser){
        try {
            String vSQL = "INSERT INTO usuario(id, nome, matricula, senha, email, telefone) "
                                      +"VALUES(?, ?, ?, ?, ?, ?);";
