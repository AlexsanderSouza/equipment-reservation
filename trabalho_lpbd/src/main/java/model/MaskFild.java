...
public abstract class MaskFild {
	...
	private static final KeyCode F1 = null;
	private static final KeyCode F2 = null;
	private static final KeyCode F3 = null;
	private static final KeyCode F4 = null;
	private static final KeyCode F5 = null;
	private static final KeyCode F6 = null;
	private static final KeyCode F7 = null;
	private static final KeyCode F8 = null;
	private static final KeyCode F9 = null;
	private static final KeyCode F10 = null;
	private static final KeyCode F11 = null;
	private static final KeyCode F12 = null;
	...
	public static void dateField(final TextField textField) {
		maxField(textField, 10); // limita a quantidade de caracteres
	...
	public static void telefoneField(final TextField textField) {
		maxField(textField, 15); // limita a quantidade de caracteres
	...
	public boolean emailField(TextField textField) {
		...
		if (value.contains("@") && value.contains(".") && !value.contains("!") && !value.contains("#")
				...
				&& !value.contains("*") && !value.contains("(") && !value.contains(")") && !value.contains("+")
				&& !value.contains("-") && !value.contains(",") && !value.contains("?") && !value.contains("{")
				&& !value.contains("}") && !value.contains("|")  && valueSplit.length < 3 && valueSplit[1].length() >= 6) {
			return true;
		} else {
